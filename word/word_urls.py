...
urlpatterns = [
    ...
    url(r'^(?P<word_id>\d+)/likes/(?P<news_id>\d+)/$', views.like_news_in_words_detail, name='like_news_in_words_detail'),
    url(r'^(?P<word_id>\d+)/dislikes/(?P<news_id>\d+)/$', views.dislike_news_in_words_detail, name='dislike_news_in_words_detail'),
    url(r'^likes/(?P<news_id>\d+)/$', views.like_news, name='like_news'),
    url(r'^likes/(?P<news_id>\d+)/$', views.like_news, name='like_news'),
